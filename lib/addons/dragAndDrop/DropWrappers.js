      ...
      switch (anchor) {
        ...
        case 'resizeBottom':
          ...
          // ... but end dates are exclusive so advance it the next slot (e.g. just past the end of this one)
            ...
            ? _dates2.default.merge(value, end)
            : _dates2.default.add(value, step, 'minutes')
          break
        ...
        case 'resizeRight':
          ...
          // the end date to one day later than the drop date because end dates are exclusive
            ...
            ? _dates2.default.add(value, 1, 'day')
            : _dates2.default.merge(value, end)
          break
...
var DroppableDateCellWrapper = (exports.DroppableDateCellWrapper = createDropWrapper(
  'dateCellWrapper'
))
var DroppableDayWrapper = (exports.DroppableDayWrapper = createDropWrapper(
  'dayWrapper'
))
